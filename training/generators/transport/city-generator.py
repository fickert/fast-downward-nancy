...
id = "city-sequential-%dnodes-%dsize-%ddegree-%dmindistance-%dtrucks-%dpackages-%dseed" % (nodes, size, degree, epsilon, trucks, packages, seed)
...
for i in range(packages):
    ...
    print("  (at package-%d city-%s)" % ( i+1, packages_position["package-%d" % (i+1)]))
