------------------------------------
This is the original instruction file with some modifications by Mak
to make it easier to understand how the generator works.  Also, the
generate_data.cc is replaced with generate_elevators.cc to expose the
parameters to the command line.

Supplemental note: The area size *must* be a factor of the number of
floors.  So, if the area size is 8, then the number of floors must
equal 40, 48, etc.  If this is not followed, then passengers will
start/end on randomly generated floors out of range, and the problems
may not be solvable.

------------------------------------


There was not Readme.txt in the generator version I [the IPC2011
organaizer] have, so this is the way I am using it. I cannot credit
the author as I don't know who was she/he.
